...
let horse = document.getElementById("paneHorse");
let ishak = document.getElementById("paneIshak");
let cat = document.getElementById("paneCat");
function removeHorse() {
  horse.style = `display: none;`;
}
function removeIshak() {
  ishak.style = `display: none;`;
}
function removeCat() {
